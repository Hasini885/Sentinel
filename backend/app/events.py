...
def publish_action(record: dict) -> str | None:
    ...
    fields = {
        ...
        "data_sensitivity": "" if record.get("data_sensitivity") is None else str(record["data_sensitivity"]),
        "external_exposure": "" if record.get("external_exposure") is None else str(record["external_exposure"]),
